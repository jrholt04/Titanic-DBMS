...
#Dr. Moorman CS3114
#
#       This is the search page for the admins. it is identical to the standard version 
#       Allows the user to search by fields for certain attributes in the DB 
#  
...
puts "<html>"
    ...
    puts "</head>"
    puts "<body>"  
        #if the form has not been submited give them the search option
        if submitted != "True"
