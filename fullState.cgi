...
#   Displays all the tables of information seperatley so the dba can visualize the structure
#
...
#display the full state of the databse 
puts "<html>"
puts "<head>"
    ...
    puts "</head>"
puts "<body>"
    puts "<a href='standard.html'>&larr; Back</a>"
